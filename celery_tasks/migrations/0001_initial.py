    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheduled_job', models.ForeignKey(blank=True, help_text='Reference to scheduled job (null for manual runs)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='runs', to='celery_tasks.scheduledscrapejob')),
